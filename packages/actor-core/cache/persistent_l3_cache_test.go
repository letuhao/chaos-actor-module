...
func TestPersistentL3Cache_New(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()

	cache, err := NewPersistentL3Cache(tempDir, 100, true)
	if err != nil {
...
func TestPersistentL3Cache_SetAndGet(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_GetNonExistent(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_SetEmptyKey(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_SetNilValue(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Expiration(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Delete(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_DeleteNonExistent(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Clear(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Stats(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_HitRate(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_UsagePercentage(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Has(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Keys(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_SetMaxSize(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Cleanup(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Close(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_Flush(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_FileSize(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_MemoryUsage(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_IndexSize(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_AverageEntrySize(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
...
func TestPersistentL3Cache_CompressionRatio(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
	...
	// Compression ratio should be < 1.0 (compression enabled)
...
func TestPersistentL3Cache_FragmentationRatio(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
	...
	// Fragmentation ratio should be low (some fragmentation due to buffer expansion)
	ratio := cache.GetFragmentationRatio()
	if ratio < 0.0 || ratio > 0.5 {
		t.Errorf("Expected fragmentation ratio to be between 0.0 and 0.5, got %f", ratio)
	}
}

func TestPersistentL3Cache_CompressionSettings(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()
	...
	cache.SetCompressionLevel(9)
	cache.SetCompressionAlgorithm("gzip")
	...
	if stats["algorithm"] != "gzip" {
		t.Errorf("Expected algorithm to be 'gzip', got %v", stats["algorithm"])
	}
	if stats["level"] != 9 {
		t.Errorf("Expected level to be 9, got %v", stats["level"])
	}
}

func TestPersistentL3Cache_NoCompression(t *testing.T) {
	// Create temporary directory
	tempDir := t.TempDir()

	cache, err := NewPersistentL3Cache(tempDir, 1000, false)
	if err != nil {
		t.Fatalf("Expected no error, got %v", err)
	}
	defer cache.Close()
...
func BenchmarkPersistentL3Cache_Set(b *testing.B) {
	// Create temporary directory
	tempDir := b.TempDir()

	cache, err := NewPersistentL3Cache(tempDir, 10000, true)
	if err != nil {
...
func BenchmarkPersistentL3Cache_Get(b *testing.B) {
	// Create temporary directory
	tempDir := b.TempDir()
...
func BenchmarkPersistentL3Cache_Concurrent(b *testing.B) {
	// Create temporary directory
	tempDir := b.TempDir()
